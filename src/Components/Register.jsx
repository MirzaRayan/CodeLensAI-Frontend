    ...
    <div className="min-h-screen w-full flex items-center justify-center">
      <div className="loginForm flex flex-col items-center justify-center sm:border-[#E0E0E0] sm:border sm:p-8 sm:py-15 rounded-lg sm:w-126 w-[80%] sm:bg-[#FFFFFF]">
        ...
        <form
          ...
          className="flex flex-col w-[90%] gap-3 mt-10"
        >
          {/* Name */}
          ...
          <input
            ...
            className="border border-[#E0E0E0] p-2 rounded-md focus:outline-none focus:ring-0 focus:border-[#E0E0E0]"
          />
          ...
          <button
            type="submit"
            className=" bg-[#185FA5] text-white rounded-md py-2 mt-5"
          >
            Create Account
          </button>
        </form>
        <h3 className="py-4 text-sm">
          Already have an Account? <span className="text-[#185FA5]">Login</span>
        </h3>
      </div>
    </div>
  );
